...
class Message: FirebaseType {
    ...
    var jsonValue: [String : AnyObject] {
        get {
            return [
                SENDER_ID_KEY : senderID as AnyObject,
                USERNAME_KEY : username as AnyObject,
                MESSAGE_TEXT_KEY : messageBodyText as AnyObject,
                THREAD_KEY : threadID as AnyObject,
                IDENTIFIER_KEY : identifier as AnyObject? ?? "" as AnyObject
            ]
        }
    }
